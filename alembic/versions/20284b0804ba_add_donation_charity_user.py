"""add Donation Charity User

Revision ID: 20284b0804ba
Revises: 
Create Date: 2023-07-25 04:23:03.208610
...
def upgrade():
    ...
    sa.Column('name', sa.String(), nullable=True, min_length=1, max_length=100),
